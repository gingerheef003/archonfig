...
nnoremap	<A-S-Down>	:co .<CR>==
nnoremap	<A-Up>		:m .-2<CR>==
nnoremap	<A-S-Up>	:co .-1<CR>==

" Insert mode
inoremap	<A-Down>	<Esc>:m .+1<CR>==gi
inoremap	<A-S-Down>	<Esc>:co .<CR>==gi
inoremap	<A-Up>		<Esc>:m .-2<CR>==gi
inoremap	<A-S-Up>	<Esc>:co .-1<CR>==gi

" Visual mode
vnoremap	<A-Down>	:m '>+1<CR>gv=gv
vnoremap	<A-S-Down>	:co '<-1<CR>gv=gv
vnoremap	<A-Up>		:m '<-2<CR>gv=gv
vnoremap	<A-S-Up>	:co '>.<CR>gv=gv
